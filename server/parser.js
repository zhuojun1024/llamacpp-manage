...
const FIELDS = {
  ...
  draftModel:       { canonical: '-md', aliases: ['-md', '--spec-draft-model', '--model-draft'], takesValue: true },
  ...
  kvUnified:        { canonical: '-kvu', aliases: ['-kvu', '--kv-unified'],   takesValue: false },
  loadMode:         { canonical: '-lm', aliases: ['-lm', '--load-mode'],      takesValue: true, type: 'string' },
  parallel:         { canonical: '-np', aliases: ['-np', '--parallel'],        takesValue: true, type: 'int' },
  batchSize:        { canonical: '-b',  aliases: ['-b', '--batch-size'],       takesValue: true, type: 'int' },
  ubatchSize:       { canonical: '-ub', aliases: ['-ub', '--ubatch-size'],     takesValue: true, type: 'int' },
  ...
  device:           { canonical: '-dev', aliases: ['-dev', '--device'],        takesValue: true },
  draftDevice:      { canonical: '-devd', aliases: ['-devd', '--spec-draft-device', '--device-draft'], takesValue: true },
...
const FIELD_META = {
  ...
  splitMode:        { label: '-sm', group: 'perf', options: ['none', 'layer', 'row', 'tensor'] },
  tensorSplit:      { label: '-ts', group: 'perf' },
  loadMode:         { label: '-lm', group: 'perf', options: ['auto', 'none', 'mmap', 'mlock', 'mmap+mlock', 'dio'] },
  cacheRam:         { label: '-cram', group: 'perf' },
  kvUnified:        { label: '-kvu', group: 'perf', bool: true },
  parallel:         { label: '-np', group: 'perf' },
  batchSize:        { label: '-b', group: 'perf' },
  ubatchSize:       { label: '-ub', group: 'perf' },
  threads:          { label: '-t', group: 'perf' },
  specType:         { label: '--spec-type', group: 'spec', options: ['none', 'draft-simple', 'draft-eagle3', 'draft-mtp', 'draft-dflash', 'draft-dspark', 'ngram-simple', 'ngram-map-k', 'ngram-map-k4v', 'ngram-mod', 'ngram-cache'] },
  ...
  reasoningEffort:  { label: '--reasoning-effort', group: 'sample', options: ['default', 'minimal', 'low', 'medium', 'high', 'xhigh', 'max'] },
  jinja:            { label: '--jinja', group: 'template', bool: true },
  chatTemplateFile: { label: '--chat-template-file', group: 'template' },
  ropeScaling:      { label: '--rope-scaling', group: 'rope', options: ['none', 'linear', 'yarn'] },
  ...
  device:           { label: '-dev', group: 'other' },
  draftDevice:      { label: '-devd', group: 'other' }
}
